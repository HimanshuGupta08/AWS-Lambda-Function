...
tag='TagSet=[{Key=Owner,Value="EnterpriseDevOps-Support@us.mcd.com"},{Key=GBL,Value="195500433516"},{Key=ApplicationID,Value="APP2000093"},{Key="Environment",Value="US-EAST-PROD-US-DEVOPS-SWAGGERHUB"}]'
db_tag='[{"Key":"Owner","Value":"EnterpriseDevOps-Support@us.mcd.com"},{"Key":"GBL","Value":"195500433516"},{"Key":"ApplicationID","Value":"APP2000093"},{"Key":"Environment","Value":"US-EAST-PROD-US-DEVOPS-SWAGGERHUB"}]'
